...
/** @brief List of all available conversions from this color space.
 *
 * @param space The color space from which to convert.
 *
 * @returns List of all available conversions from this color space. */
QList<RgbColor::Conversion> RgbColor::conversionsFrom(const ColorSpace space)
{
    QList<RgbColor::Conversion> result;
 ...
 * @param space The color space from which to perform conversions.
 *
 * @pre <em>values</em> contains the key <em>space</em>.
 *
 * @post For all available direct conversions from <em>space</em>, it is
 * checked whether a value for the destination color space is already
...
void RgbColor::addDirectConversionsRecursivly(QHash<ColorSpace, GenericColor> *values, ColorSpace space)
{
...
/** @brief Calculate conversions to all color spaces.
 *
 * @param space The original color space
...
QHash<ColorSpace, GenericColor> RgbColor::allConversions(const ColorSpace space, const GenericColor &value)
{
...
GenericColor RgbColor::fromOklabToXyzD65(const GenericColor &value)
{
 ...
 * <a href="https://bottosson.github.io/posts/oklab/">
 * Oklab color space</a>. */
GenericColor RgbColor::fromXyzD65ToOklab(const GenericColor &value)
{
    // The following algorithm is as described in
    // https://bottosson.github.io/posts/oklab/#converting-from-xyz-to-oklab
    //
...
GenericColor RgbColor::fromXyzD65ToXyzD50(const GenericColor &value)
{
 ...
 *
 * @returns the converted color */
GenericColor RgbColor::fromXyzD50ToXyzD65(const GenericColor &value)
{
 ...
 *
 * @returns the converted color */
GenericColor RgbColor::fromXyzD50ToCielabD50(const GenericColor &value)
{
 ...
 *
 * @returns the converted color */
GenericColor RgbColor::fromCielabD50ToXyzD50(const GenericColor &value)
{
...
GenericColor RgbColor::fromCartesianToPolar(const GenericColor &value)
{
 ...
 * (format: ignored, radius, angleDegree, ignored) and Cartesian coordinates
 * (format: ignored, x, y, ignored). */
GenericColor RgbColor::fromPolarToCartesian(const GenericColor &value)
{
